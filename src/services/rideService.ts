...
export class RideService {
  ...
  public static async acceptRideRequest(requestId: string, driver: StudentProfile): Promise<boolean> {
    ...
    // Ensure driver has a proper campus driver name (never student passenger like Demo Student 1)
    const isActuallyDriver = driver.accountType === 'driver' && driver.name !== 'Demo Student 1';
